...
import static org.p2p.solanaj.programs.TokenProgram.*;
...
public class TokenProgramTest {
    ...
    public void decodeMintData() {
        MintData mintData = MintData.decode(Base64.getDecoder().decode(
    ...
    public void decodeAccountInfoData() {
        AccountInfoData accountInfoData = AccountInfoData.decode(Base64.getDecoder().decode(
    ...
    public void decodeAccountInfoData1() {
        ...
        accountInfoData = AccountInfoData.decode(Base64.getDecoder().decode(
