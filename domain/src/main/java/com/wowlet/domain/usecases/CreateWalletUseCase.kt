...
class CreateWalletUseCase(
    ...
    override fun generatePhrase(): String {
        // phraseList = wowletApiCallRepository.generatePhrase() miracle pizza supply useful steak border same again youth silver access hundred
...
//        phraseList.add("hundred")
        ...
        return phraseList.joinToString(separator = " ")
    }
