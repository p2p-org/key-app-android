package com.wowlet.data.util.mnemoticgenerator;

import java.util.Arrays;

import static com.wowlet.data.util.mnemoticgenerator.ByteUtils.next11Bits;
import static com.wowlet.data.util.mnemoticgenerator.Sha256.sha256;
