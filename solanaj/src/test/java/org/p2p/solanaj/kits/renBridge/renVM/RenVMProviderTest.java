...
//        RpcSolanaRepository repository = new RpcSolanaRepositoryMock();
//        RenVMProvider renVMProvider = new RenVMProvider(repository);
...
//                Utils.toURLBase64(renVMProvider.getTxHash(mintTx, "BTC/toSolana")));
//    }
