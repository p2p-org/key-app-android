...
import org.p2p.ethereumkit.api.jsonrpc.*
...
import org.p2p.ethereumkit.core.*
...
class RpcBlockchain(
    ...
    companion object {
        fun instance(address: EthAddress,
                     storage: IApiStorage,
                     syncer: IRpcSyncer,
        ...
        fun callRpc(contractAddress: EthAddress, data: ByteArray, defaultBlockParameter: DefaultBlockParameter): DataJsonRpc =
