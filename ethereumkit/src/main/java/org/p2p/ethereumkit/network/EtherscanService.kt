...
import org.p2p.ethereumkit.api.models.EtherscanResponse
import org.p2p.ethereumkit.core.retryWhenError
...
class EtherscanService(
    ...
    fun getTransactionList(address: EthAddress, startBlock: Long): Single<EtherscanResponse> {
    ...
    fun getInternalTransactionList(address: EthAddress, startBlock: Long): Single<EtherscanResponse> {
        return service.accountApi(
    ...
    fun getTokenTransactions(address: EthAddress, startBlock: Long): Single<EtherscanResponse> {
        return service.accountApi(
            action = "tokentx",
            address = address.hex,
            startBlock = startBlock,
    ...
    fun getEip721Transactions(address: EthAddress, startBlock: Long): Single<EtherscanResponse> {
        return service.accountApi(
            action = "tokennfttx",
            address = address.hex,
            startBlock = startBlock,
    ...
    fun getEip1155Transactions(address: EthAddress, startBlock: Long): Single<EtherscanResponse> {
        return service.accountApi(
            action = "token1155tx",
            address = address.hex,
            startBlock = startBlock,
