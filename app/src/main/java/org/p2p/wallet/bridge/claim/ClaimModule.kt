...
import org.p2p.wallet.bridge.claim.repository.EthereumClaimInMemoryRepository
...
object ClaimModule : InjectionModule {
    ...
    override fun create() = module {
        ...
        singleOf(::EthereumClaimInMemoryRepository) bind EthereumClaimLocalRepository::class
