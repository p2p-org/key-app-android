...
import org.p2p.wallet.swap.ui.jupiter.settings.presenter.SwapSettingsPayload.MINIMUM_RECEIVED
...
class SwapSettingsDecorator : ItemDecoration() {
    ...
    override fun getItemOffsets(outRect: Rect, view: View, parent: RecyclerView, state: RecyclerView.State) {
        ...
        when {
            item is FinanceBlockCellModel && item.payload == MINIMUM_RECEIVED ->
