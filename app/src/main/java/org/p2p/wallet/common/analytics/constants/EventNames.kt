...
object EventNames {
    ...
    const val ONBOARD_CREATE_PHONE_CLICK_BUTTON = "Create_Phone_Click_Button"
    const val ONBOARD_CREATE_SMS_SCREEN = "Create_Sms_Screen"
    const val ONBOARD_CREATE_SMS_VALIDATION = "Create_Sms_Validation"
    const val ONBOARD_RESTORE_PHONE_SCREEN = "Restore_Phone_Screen"
    const val ONBOARD_RESTORE_SMS_PHONE_CLICK_BUTTON = "Restore_Phone_Click_Button"
    const val ONBOARD_RESTORE_SMS_SCREEN = "Restore_Sms_Screen"
    const val ONBOARD_RESTORE_SMS_VALIDATION = "Restore_Sms_Validation"
