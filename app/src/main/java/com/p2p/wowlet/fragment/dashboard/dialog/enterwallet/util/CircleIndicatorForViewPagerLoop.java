package com.p2p.wowlet.fragment.dashboard.dialog.enterwallet.util;
...
public class  CircleIndicatorForViewPagerLoop extends CircleIndicator3 {
    ...
    public CircleIndicatorForViewPagerLoop(Context context) {
        super(context);
    }

    public CircleIndicatorForViewPagerLoop(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircleIndicatorForViewPagerLoop(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CircleIndicatorForViewPagerLoop(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private final ViewPager2.OnPageChangeCallback mInternalPageChangeCallback =
            new ViewPager2.OnPageChangeCallback() {
                @Override public void onPageSelected(int position) {
                    ...
                    if (position > 1 && position < realItemCount + 2) {
                        position-=2;
