 ...
 */
public class ScrollingPagerIndicatorLoop extends ScrollingPagerIndicator {
    ...
    private ru.tinkoff.scrollingpagerindicator.ScrollingPagerIndicator.PagerAttacher<?> currentAttacher;

    private boolean dotCountInitialized;

    public ScrollingPagerIndicatorLoop(Context context) {
        this(context, null);
    }

    public ScrollingPagerIndicatorLoop(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.scrollingPagerIndicatorStyle);
    }

    public ScrollingPagerIndicatorLoop(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     */
    @ru.tinkoff.scrollingpagerindicator.ScrollingPagerIndicator.Orientation
     ...
     */
    public void setOrientation(@ru.tinkoff.scrollingpagerindicator.ScrollingPagerIndicator.Orientation int orientation) {
     ...
     */
    public <T> void attachToPager(@NonNull final T pager, @NonNull final ru.tinkoff.scrollingpagerindicator.ScrollingPagerIndicator.PagerAttacher<T> attacher) {
        detachFromPager();
    ...
    public void onPageScrolled(int page, float offset) {
        ...
        if (page > 1 && page < itemCount + 2) {
            page -= 2;
        }else if (page == itemCount + 2){
            page = 0;
        }else if (page == 0) {
            page = itemCount - 2;
        }else if (page == 1) {
    ...
    public interface PagerAttacher<T> {
         ...
         * You must call:
         * {@link ru.tinkoff.scrollingpagerindicator.ScrollingPagerIndicator#setDotCount(int)} - initially and after page selection,
         * {@link ru.tinkoff.scrollingpagerindicator.ScrollingPagerIndicator#setCurrentPosition(int)} - initially and after page selection,
         * {@link ru.tinkoff.scrollingpagerindicator.ScrollingPagerIndicator#onPageScrolled(int, float)} - in your pager callback to track scroll offset,
         * {@link ru.tinkoff.scrollingpagerindicator.ScrollingPagerIndicator#reattach()} - each time your adapter items change.
         *
         * @param indicator indicator
         * @param pager     pager to attach
         */
        void attachToPager(@NonNull ru.tinkoff.scrollingpagerindicator.ScrollingPagerIndicator indicator, @NonNull T pager);
