package com.p2p.wowlet.dashboard.ui.dialog.recoveryphrase
...
import com.p2p.wowlet.dashboard.ui.dialog.recoveryphrase.adapter.RecoveryPhraseAdapter
...
class RecoveryPhraseDialog : DialogFragment() {
    ...
    private fun observe() {
        ...
        viewModel.getSortSecretData.observe(
            viewLifecycleOwner,
            {
