package com.p2p.wowlet.dashboard.view
...
import com.p2p.wowlet.dashboard.adapter.WalletsAdapter
import com.p2p.wowlet.dashboard.dialog.BackupDialog
import com.p2p.wowlet.dashboard.dialog.ProfileDetailsFragment
import com.p2p.wowlet.dashboard.dialog.SecurityDialog
import com.p2p.wowlet.dashboard.dialog.TransactionBottomSheet
import com.p2p.wowlet.dashboard.dialog.addcoin.AddCoinBottomSheet
import com.p2p.wowlet.dashboard.dialog.addcoin.AddCoinBottomSheet.Companion.TAG_ADD_COIN
import com.p2p.wowlet.dashboard.dialog.allmytokens.AllMyTokensBottomSheet
import com.p2p.wowlet.dashboard.dialog.allmytokens.AllMyTokensBottomSheet.Companion.TAG_ALL_MY_TOKENS_DIALOG
import com.p2p.wowlet.dashboard.dialog.currency.CurrencyDialog
import com.p2p.wowlet.dashboard.dialog.detailwallet.DetailWalletBottomSheet
import com.p2p.wowlet.dashboard.dialog.detailwallet.DetailWalletBottomSheet.Companion.DETAIL_WALLET
import com.p2p.wowlet.dashboard.dialog.enterwallet.EnterWalletBottomSheet
import com.p2p.wowlet.dashboard.dialog.enterwallet.EnterWalletBottomSheet.Companion.ENTER_WALLET
import com.p2p.wowlet.dashboard.dialog.networks.NetworksDialog
import com.p2p.wowlet.dashboard.dialog.profile.ProfileDialog
import com.p2p.wowlet.dashboard.dialog.recoveryphrase.RecoveryPhraseDialog
import com.p2p.wowlet.dashboard.dialog.savedcards.SavedCardsDialog
import com.p2p.wowlet.dashboard.dialog.sendyourwallet.YourWalletBottomSheet
