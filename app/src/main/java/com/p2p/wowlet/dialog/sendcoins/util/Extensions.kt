package com.p2p.wowlet.dialog.sendcoins.util

import java.lang.IllegalStateException

fun String.toShortenedPublicKeyFormat(prefixLength: Int, suffixLength: Int, numberOfPoints: Int): String {
    if (this.length < prefixLength + suffixLength) throw IllegalStateException("Prefix and/or Suffix cant be longer than the actual string")
