...
class ReceiveInfoBottomSheetDialog : NonDraggableBottomSheetDialogFragment() {

    companion object {
        fun show(fm: FragmentManager) {
            ReceiveInfoBottomSheetDialog()
                .show(fm, ReceiveInfoBottomSheetDialog::javaClass.name)
        }
    }
